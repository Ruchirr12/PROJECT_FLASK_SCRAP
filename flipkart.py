...
def scrap():
    ...
    for i in range(len(product_links)):
        ...
        review_page_link = [li.get('href') for li in
                            product_html.find_all('a', attrs={'href': re.compile("/product-reviews/")})]

        # this will be our link for the all reviews page
        recent_ReviewPage = review_page_link[-1].replace("marketplace=FLIPKART",
